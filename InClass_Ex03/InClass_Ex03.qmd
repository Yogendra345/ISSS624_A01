...
4.  In simple words, 'Hedonic pricing' ***uses regression*** to see which factors matter the most and relative importance of each factor.

## 2. The Data.

Two data sets will be used in this model building exercise, they are:

1.  URA Master Plan sub-zone boundary in shapefile format (i.e. *MP14_SUBZONE_WEB_PL*)
...
-   [**corrplot**](https://cran.r-project.org/web/packages/corrplot/vignettes/corrplot-intro.html) **-** R package for multivariate data visualization and analysis
...
## 4. Important note on GWmodel.

[**GWmodel**](https://www.jstatsoft.org/article/view/v063i17) package provides a collection of localized spatial statistical methods, namely :
...
1.  CV cross-validation approach and
...
-   **Quiz: Do you know why it is in meter?**
    ...
    The [**bandwidth is the distance**]{.underline} beyond which a value of zero is assigned to weight observations. Larger bandwidths include a larger number of observations receiving a non-zero weight and more observations are used to fit a local regression. We are trying to find similar neighbors within a given distance and hence recommended bandwidth is in meters. See the following graph to understand more.

    ![Fixed Bandwidth](images/Fixed%20Bandwidth.png)
