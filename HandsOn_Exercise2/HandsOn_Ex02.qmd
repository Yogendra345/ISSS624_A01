---
title: "Hands-On_Ex02 : Choropleth Mapping with R "
author: "Yogendra"
editor: visual
---
...
Let us examine contents of mpsz.
...
Before thematic map can be prepared, we are required to prepare a data table with year 2020 values. The data table should include the variables PA, SZ, YOUNG, ECONOMY ACTIVE, AGED, TOTAL, DEPENDENCY.
...
##### 3.4.1.1 Joining the attribute data and geospatial data.
...
Next, *left_join()* of **dplyr** is used to join the geographical data and attribute table using planning sub zone name e.g. *SUBZONE_N* and *SZ* as the common identifier.
...
#### 4.2.4.2 Plotting choropleth map with custome break
...
5.4 Drawing Small Multiple Choropleth Maps
...
5.4.1 By assigning multiple values to at least one of the aesthetic arguments
...
5.4.2 By defining a group-by variable in *tm_facets()*
...
#### 5.4.3 By creating multiple stand-alone maps with *tmap_arrange()*
